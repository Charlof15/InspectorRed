package com.ffm.inspector.red.configuration.security;
...
public class SeguridadFiltroConfig extends OncePerRequestFilter{
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
		...
		} catch (ExpiredJwtException | UnsupportedJwtException | MalformedJwtException | NullPointerException | IOException e) {
